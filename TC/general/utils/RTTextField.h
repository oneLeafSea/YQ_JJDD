...
@protocol RTTextFieldDelegate;

@interface RTTextField : UITextField <UITableViewDelegate, UITableViewDataSource, UIPopoverControllerDelegate, UITextFieldDelegate, UIGestureRecognizerDelegate>

@property (nonatomic, weak) id <RTTextFieldDelegate, UITextFieldDelegate> delegate;
...
@protocol RTTextFieldDelegate <NSObject>
